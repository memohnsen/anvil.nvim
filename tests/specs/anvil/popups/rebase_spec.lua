...
local rebase_actions = require("anvil.popups.rebase.actions")
...
describe("rebase popup actions", function()
  ...
  before_each(function()
    ...
    original_fuzzy = require("anvil.buffers.fuzzy_finder").new
  ...
  after_each(function()
    ...
    require("anvil.buffers.fuzzy_finder").new = original_fuzzy
  ...
  it("onto_upstream resolves upstream and calls rebase without fuzzy finder", function()
    ...
    require("anvil.buffers.fuzzy_finder").new = function(...)
