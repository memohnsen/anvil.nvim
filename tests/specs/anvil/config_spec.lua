...
describe("Anvil config", function()
  ...
  describe("validation", function()
    ...
    describe("for good configs", function()
      ...
      it("should map section navigation keys by default", function()
        assert.are.same("NextSection", config.values.mappings.status["]]"])
        assert.are.same("PreviousSection", config.values.mappings.status["[["])
