...
local client = require("neogit.forge.client")
...
function M.list_issues_buffer(_)
  ...
  require("neogit.buffers.forge_topics_view").new(forge.topics().issues, "Forge Issues"):open()
end
...
function M.list_pullreqs_buffer(_)
  ...
  require("neogit.buffers.forge_topics_view").new(forge.topics().pullreqs, "Forge Pull Requests"):open()
end
...
function M.list_discussions_buffer(_)
  ...
  require("neogit.buffers.forge_topics_view").new(forge.topics().discussions, "Forge Discussions"):open()
end
...
function M.list_notifications(_)
  ...
  require("neogit.buffers.forge_notifications_view").new(forge.topics().notifications):open()
end
