...
function M:comment()
  self.post_editor = require("neogit.buffers.forge_post_editor")
    .new {
...
function M:open(kind)
  local name = ("NeogitForgeTopic://%s/%s"):format(self.topic.kind or "topic", self.topic.number or "unknown")

  self.buffer = Buffer.create {
    name = name,
    filetype = "NeogitForgeTopic",
