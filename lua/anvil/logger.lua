...
local default_config = {
  ...
  use_console = vim.env.ANVIL_LOG_CONSOLE or false,
  highlights = vim.env.ANVIL_LOG_HIGHLIGHTS or (vim.env.ANVIL_LOG_CONSOLE or false),
  use_file = vim.env.ANVIL_LOG_FILE or false,
  level = vim.env.ANVIL_LOG_LEVEL or "info",
...
log.new = function(config, standalone)
  ...
  local log_at_level = function(level, level_config, message_maker, ...)
    ...
    local lineinfo = info.short_src:gsub(".+/anvil/lua/anvil/", "") .. ":" .. info.currentline
