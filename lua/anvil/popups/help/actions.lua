...
local status_mappings = require("anvil.config").get_reversed_status_maps()
local popup_mappings = require("anvil.config").get_reversed_popup_maps()
...
M.popups = function(env)
  ...
  local items = {
    ...
    { "InitRepo", "Init", require("anvil.lib.git").init.init_repo },
    ...
    { "Command", "Command", require("anvil.buffers.status.actions").n_command(nil) },
  }
