...
local client = require("anvil.client")
local utils = require("anvil.lib.util")
...
function M.create_tag(popup)
  local tag_input = input.get_user_input("Create tag", {
    strip_spaces = true,
    completion = "customlist,v:lua.require'anvil.lib.git'.refs.list_tags",
  })
