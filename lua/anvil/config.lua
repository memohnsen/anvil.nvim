...
---@class AnvilCommitBufferConfig Commit buffer options
...
---@class AnvilConfigPopup Popup window options
---@field kind WindowKind The type of window that should be opened
---@field show_title boolean Show a title for the popup

---@class AnvilConfigFloating
...
---@class AnvilCommitEditorConfigPopup Popup window options
---@field kind WindowKind The type of window that should be opened
...
---@alias AnvilConfigSignsIcon { [1]: string, [2]: string }

---@class AnvilConfigSigns
---@field hunk AnvilConfigSignsIcon The icons to use for open and closed hunks
---@field item AnvilConfigSignsIcon The icons to use for open and closed items
---@field section AnvilConfigSignsIcon The icons to use for open and closed sections

---@class AnvilConfigSection A section to show in the Anvil Status buffer, e.g. Staged/Unstaged/Untracked
...
---@class AnvilConfigSections
---@field untracked AnvilConfigSection|nil
---@field unstaged AnvilConfigSection|nil
---@field staged AnvilConfigSection|nil
---@field stashes AnvilConfigSection|nil
---@field unpulled_upstream AnvilConfigSection|nil
---@field unmerged_upstream AnvilConfigSection|nil
---@field unpulled_pushRemote AnvilConfigSection|nil
---@field unmerged_pushRemote AnvilConfigSection|nil
---@field recent AnvilConfigSection|nil
---@field rebase AnvilConfigSection|nil
---@field sequencer AnvilConfigSection|nil
---@field bisect AnvilConfigSection|nil
---@field wip AnvilConfigSection|nil
---@field discussions AnvilConfigSection|nil
...
---@class AnvilFilewatcherConfig
---@field enabled boolean
---@field filewatcher AnvilFilewatcherConfig|nil

---@alias AnvilConfigMappingsFinder
---| "Select"
---| "Close"
---| "Next"
---| "Previous"
...
---@alias AnvilConfigMappingsStatus
---| "Close"
---| "MoveDown"
---| "MoveUp"
---| "OpenTree"
...
---@alias AnvilConfigMappingsPopup
---| "HelpPopup"
---| "DiffPopup"
---| "PullPopup"
---| "RebasePopup"
...
---@alias AnvilConfigMappingsRebaseEditor
---| "Pick"
---| "Reword"
---| "Edit"
---| "Squash"
...
---@alias AnvilConfigMappingsCommitEditor
---| "Close"
---| "Submit"
---| "Abort"
---| "PrevMessage"
...
---@alias AnvilConfigMappingsCommitEditor_I
---| "Submit"
---| "Abort"
---| false
---| fun()

---@alias AnvilConfigMappingsRebaseEditor_I
---| "Submit"
---| "Abort"
---| false
---| fun()
---
---@alias AnvilConfigMappingsRefsView
---| "DeleteBranch"
---| false
---| fun()

---@alias AnvilGraphStyle
---| "ascii"
---| "unicode"
---| "kitty"
---
---@alias AnvilCommitOrder
---| ""
---| "topo"
---| "author-date"
---| "date"

---@class AnvilConfigStatusOptions
...
---@class AnvilConfigMappings Consult the config file or documentation for values
---@field finder? { [string]: AnvilConfigMappingsFinder } A dictionary that uses finder commands to set multiple keybinds
---@field status? { [string]: AnvilConfigMappingsStatus } A dictionary that uses status commands to set a single keybind
---@field popup? { [string]: AnvilConfigMappingsPopup } A dictionary that uses popup commands to set a single keybind
---@field rebase_editor? { [string]: AnvilConfigMappingsRebaseEditor } A dictionary that uses Rebase editor commands to set a single keybind
---@field rebase_editor_I? { [string]: AnvilConfigMappingsRebaseEditor_I } A dictionary that uses Rebase editor commands to set a single keybind
---@field commit_editor? { [string]: AnvilConfigMappingsCommitEditor } A dictionary that uses Commit editor commands to set a single keybind
---@field commit_editor_I? { [string]: AnvilConfigMappingsCommitEditor_I } A dictionary that uses Commit editor commands to set a single keybind
---@field refs_view? { [string]: AnvilConfigMappingsRefsView } A dictionary that uses Refs view editor commands to set a single keybind

---@class AnvilConfigGitService
---@field pull_request? string
---@field commit? string
---@field tree? string

---@class AnvilConfigWip
---@field enabled boolean Automatically write WIP refs around mutating Anvil git operations
...
---@class AnvilConfigForgeNotifications
---@field poll boolean Automatically poll GitHub notifications
---@field interval integer Poll interval in milliseconds

---@class AnvilConfigForge
---@field notifications AnvilConfigForgeNotifications Forge notification options

---@class AnvilConfig Anvil configuration settings
---@field filewatcher? AnvilFilewatcherConfig Values for filewatcher
---@field graph_style? AnvilGraphStyle Style for graph
...
---@field disable_signs? boolean Special signs to draw for sections etc. in Anvil
...
---@field git_services? AnvilConfigGitService[] Templates to use when opening a pull request for a branch, or commit
---@field wip? AnvilConfigWip Work-in-progress snapshot options
---@field forge? AnvilConfigForge Forge options
...
---@field remember_settings? boolean Whether anvil should persist flags from popups, e.g. git push flags
---@field sort_branches? string Value used for `--sort` for the `git branch` command
---@field commit_order? AnvilCommitOrder Value used for `--<commit_order>-order` for the `git log` command
...
---@field kind? WindowKind The default type of window anvil should open in
---@field floating? AnvilConfigFloating The floating window style
...
---@field status? AnvilConfigStatusOptions Status buffer options
---@field commit_editor? AnvilCommitEditorConfigPopup Commit editor options
---@field commit_select_view? AnvilConfigPopup Commit select view options
---@field stash? AnvilConfigPopup Commit select view options
---@field commit_view? AnvilCommitBufferConfig Commit buffer options
---@field log_view? AnvilConfigPopup Log view options
---@field rebase_editor? AnvilConfigPopup Rebase editor options
---@field reflog_view? AnvilConfigPopup Reflog view options
---@field refs_view? AnvilConfigPopup Refs view options
---@field merge_editor? AnvilConfigPopup Merge editor options
---@field preview_buffer? AnvilConfigPopup Preview options
---@field popup? AnvilConfigPopup Set the default way of opening popups
---@field signs? AnvilConfigSigns Signs used for toggled regions
...
---@field sections? AnvilConfigSections
---@field ignored_settings? string[] Settings to never persist, format: "Filetype--cli-value", i.e. "AnvilCommitPopup--author"
---@field mappings? AnvilConfigMappings
...
---Returns the default Anvil configuration
---@return AnvilConfig
...
function M.setup(opts)
  ...
  local header = "====Anvil Configuration Errors===="
  local header_message = {
    "Anvil has NOT been setup!",
    "You have a misconfiguration in your Anvil setup!",
    'Validate that your configuration passed to `require("anvil").setup()` is valid!',
  }
  local header_sep = ""
