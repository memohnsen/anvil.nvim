...
---@field internal? boolean Whether the switch is internal to anvil or should be included in the cli command. If `true` we don't include it in the cli command.
